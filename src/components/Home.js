                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className="section__carousel-wrap">
                                <OwlCarousel nav={true} loop={true} items={4} className="section__interview owl-carousel" id="flixtv">
                                    <div className="interview">
                                        ...
                                        <h3 className="interview__title"><a href="interview.html">What Was Ben Affleck Planning for His Unmade 'Batman' Film?</a></h3>
                                    </div>
                                    <div className="interview">
                                        <a href="interview.html" className="interview__cover">
                                            <img src="img/interview/1.jpg" alt="" />
