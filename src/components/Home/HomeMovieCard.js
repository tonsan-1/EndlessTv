...
export default function HomeMovieCard({ movie }) {
    ...
    function addMovieToFavorites(e) {
        ...
        movieService.getFavoriteMovies(user.uid)
            .then(res => {
                if (res !== null) {
                    setFavorites(res);
        ...
        if (Object.keys(favorites).length > 0) {
            ...
            Object.keys(favorites).forEach(favoriteMovieId => {
                if (favorites[favoriteMovieId].movieId === movie.id) {
                    ...
                    movieService.addToFavorites(user.uid, movie.id);
                }
            });
        } else {
            console.log(
    ...
    return (
        <div class="card">
            ...
            <button onClick={addMovieToFavorites} class="card__add" type="button">
