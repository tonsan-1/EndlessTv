...
export default function FavovitesMovieCard({ movie }) {
    const { removeMovieFromFavorites } = useContext(GlobalMovieContext);
    ...
    return (
        <div class="col-12 col-sm-6 col-lg-3 col-xl-3">
            <div className="card">
                ...
                <button onClick={() => removeMovieFromFavorites(movie.id)} className="card__remove" type="button">
