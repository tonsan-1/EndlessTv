                                            ...
                                            <div className="catalog__paginator-wrap">
                                                ...
                                                {totalPages > 1 ?
                                                    <ul className="catalog__paginator">
                                                        <li>
                                                            <Link to={`/categories/${genreId}/${genreName}/${currentPage > 1 ? currentPage - 1 : totalPages}`}>
                                                        ...
                                                        <li>
                                                            <Link to={`/categories/${genreId}/${genreName}/${currentPage < totalPages ? currentPage + 1 : 1}`}>
