...
import BlankPoster from '../../img/BlankPoster.png'

export default function CategoryMovieCard({ movie }) {
        ...
        <div className={addToFavoritesClassName}>
            ...
            <h3 className="card__title">
                <Link to={`/details/${movie.id}`}>
                    {movie.title} {`(${movie.release_date !== undefined ? movie.release_date.substring(0, 4) : ""})`}
                </Link>
            </h3>
        </div>
    )
